...
!(function (t, e) {
    ...
    function r(t) {
        var e,
            n = o;
        if (0.05 <= t - c) for (c = t; n; ) ((e = n.g(n.t, n.p)) !== n.v1 || 0.2 < t - n.t1) && ((n.v2 = n.v1), (n.v1 = e), (n.t2 = n.t1), (n.t1 = t)), (n = n._next);
    }
    function t() {
        ...
        h = (function () {
            ...
            return (
                (e.get = function get(t, e) {
                    var n,
                        r,
                        i = this._props[t] || console.warn("Not tracking " + t + " velocity.");
                    return (
    ...
    var v,
        ...
        j = (function (t) {return true})(window ? window.location.host : ""),
        B = Array.isArray,
        R = 1e10,
        S = { resistance: 1, checkpoint: 1, preventOvershoot: 1, linkedProps: 1, radius: 1, duration: 1 },
        D = {
            version: "3.4.3",
            name: "inertia",
                ...
                var a,
                    ...
                    _ = L(m)
                        ...
                        : (function _calculateTweenDuration(t, e, n, r, i, o) {
                              ...
                              for (a in ((h = fa(t, y, w, k)), y))
                                  S[a] ||
                                      ((c = y[a]),
                                      M(c) || ((g = g || C(t)) && g.isTracking(a) ? (c = L(c) ? { velocity: c } : { velocity: g.get(a) }) : ((u = +c || 0), (s = Math.abs(u / k)))),
                                      M(c) &&
                                          ((u = L(c.velocity) ? c.velocity : (g = g || C(t)) && g.isTracking(a) ? g.get(a) : 0),
                                          (s = O(r, n, Math.abs(u / ba(c, "resistance", k)))),
                                          (l = (f = parseFloat(w(t, a)) || 0) + ca(u, s)),
                                          "end" in c && ((c = aa(c, h && a in h ? h : l, c.max, c.min, a, y.radius)), o && (A === e && (A = y = $(e)), (y[a] = Z(c, y[a], "end")))),
                                          "max" in c && l > +c.max + 1e-10
                                              ? ((d = c.unitFactor || P.unitFactors[a] || 1), (p = (f > c.max && c.min !== c.max) || (-15 < u * d && u * d < 45) ? r + 0.1 * (n - r) : da(f, c.max, u)) + i < m && (m = p + i))
                                              : "min" in c &&
                                                l < c.min - 1e-10 &&
                                                ((d = c.unitFactor || P.unitFactors[a] || 1), (p = (f < c.min && c.min !== c.max) || (-45 < u * d && u * d < 15) ? r + 0.1 * (n - r) : da(f, c.min, u)) + i < m && (m = p + i)),
                                          v < p && (v = p)),
                                      v < s && (v = s));
                              return m < v && (v = m), n < v ? n : v < r ? r : v;
                          })(t, e, (y && m.max) || 10, (y && m.min) || 0.2, y && "overshoot" in m ? +m.overshoot : w ? 0 : 1, !0);
                for (a in ((e = A), (A = 0), (d = fa(t, e, v, k)), e))
                    S[a] ||
                        ((c = e[a]),
                        N(c) && (c = c(r, t, i)),
                        ...
                        M(c) &&
                            ((p = s + l),
                            "end" in c && (c = aa(c, d && a in d ? d : p, c.max, c.min, a, e.radius)),
                            "max" in c && +c.max < p ? (w || c.preventOvershoot ? (l = c.max - s) : (g = c.max - s - l)) : "min" in c && +c.min > p && (w || c.preventOvershoot ? (l = c.min - s) : (g = c.min - s - l))),
                        this._props.push(a),
