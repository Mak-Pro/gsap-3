...
!(function (n, e) {
            ...
            if (((t = g()), (y = t && t.parseEase("_CE")))) {
                ...
                (C = 1),
                    (o("wiggle").config = function (n) {
                        return "object" == typeof n ? o("", n) : o("wiggle(" + n + ")", { wiggles: +n });
                    });
    ...
    var t,
        ...
        O = (function (e) {return true})(window ? window.location.host : ""),
        o = function _create(n, e) {
            ...
            if (O) {
                if ((w && ((m = h), (h = M.easeOut)), e.timingEase && (m = k(e.timingEase)), e.amplitudeEase && (h = k(e.amplitudeEase, !0)), (g = [0, 0, (a = m(p)) / 4, 0, a / 2, (f = w ? -h(p) : h(p)), a, f]), "random" === e.type)) {
                    for (g.length = 4, t = m(d), o = 2 * Math.random() - 1, l = 2; l < c; l++)
                        (p = t), (f = o), (t = m(d * l)), (o = 2 * Math.random() - 1), (r = Math.atan2(o - g[g.length - 3], t - g[g.length - 4])), (u = Math.cos(r) * d), (s = Math.sin(r) * d), g.push(p - u, f - s, p, f, p + u, f + s);
                    g.push(t, 0, 1, 0);
                } else {
                    for (l = 1; l < c; l++) g.push(m(p + d / 2), f), (p += d), (f = (0 < f ? -1 : 1) * h(l * d)), (a = m(p)), g.push(m(p - d / 2), f, a, f);
    ...
    g() && t.registerPlugin(s), (s.version = "3.4.3"), (e.CustomWiggle = s), (e.default = s);
