...
!(function (t, e) {
    ...
    function arcToSegment(t, e, n, i, s, a, o, r, h) {
        if (t !== r || e !== h) {
            ...
            var x = (a === o ? -1 : 1) * K(w),
                ...
                H = (-m - C) / i,
                R = M * M + D * D,
                N = (D < 0 ? -1 : 1) * Math.acos(M / K(R)),
                L = (M * H - D * T < 0 ? -1 : 1) * Math.acos((M * T + D * H) / K(R * (T * T + H * H)));
            isNaN(L) && (L = u), !o && 0 < L ? (L -= p) : o && L < 0 && (L += p), (N %= p), (L %= p);
            var z,
                X = Math.ceil(U(L) / (p / 4)),
                O = [],
                I = L / X,
                ...
                Y = d * -i,
                B = c * i;
            for (z = 0; z < X; z++) (_ = F((s = N + z * I))), (m = W(s)), (M = F((s += I))), (D = W(s)), O.push(_ - G * m, m + G * _, M + G * D, D - G * M, M, D);
            for (z = 0; z < O.length; z += 2) (_ = O[z]), (m = O[z + 1]), (O[z] = _ * V + m * Y + E), (O[z + 1] = _ * q + m * B + k);
            return (O[z - 2] = r), (O[z - 1] = h), O;
        }
    }
    function stringToRawPath(t) {
        ...
        for (e = 0; e < y; e++)
            if (((p = a), isNaN(_[e]) ? (o = (a = _[e].toUpperCase()) !== _[e]) : e--, (i = +_[e + 1]), (s = +_[e + 2]), o && ((i += v), (s += b)), e || ((h = i), (l = s)), "M" === a))
            ...
            else if ("S" === a) (c = v), (d = b), ("C" !== p && "S" !== p) || ((c += v - r[r.length - 4]), (d += b - r[r.length - 3])), o || (v = b = 0), r.push(c, d, i, s, (v += 1 * _[e + 3]), (b += 1 * _[e + 4])), (e += 4);
            ...
            else if ("H" === a) td(v, b, (v = i), b), (e += 1);
            else if ("V" === a) td(v, b, v, (b = i + (o ? b - v : 0))), (e += 1);
            else if ("L" === a || "Z" === a) "Z" === a && ((i = h), (s = l), (r.closed = !0)), ("L" === a || 0.5 < U(v - i) || 0.5 < U(b - s)) && (td(v, b, i, s), "L" === a && (e += 2)), (v = i), (b = s);
            else if ("A" === a) {
                if (
                    ((g = _[e + 4]),
                    (f = _[e + 5]),
                    ...
                    (d = _[e + 7]),
                    (n = 7),
                    1 < g.length && (g.length < 3 ? ((d = c), (c = f), n--) : ((d = f), (c = g.substr(2)), (n -= 2)), (f = g.charAt(1)), (g = g.charAt(0))),
                    (u = arcToSegment(v, b, +_[e + 1], +_[e + 2], +_[e + 3], +g, +f, (o ? v : 0) + 1 * c, (o ? b : 0) + 1 * d)),
                    (e += n),
                    u)
                )
    ...
    function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
        ...
        return (
            ...
            h * (x * x + S * S) < (C + E) * (C + E) && ((d = l.length), bezierToPoints(t, e, u, p, v, b, A, w, h, l, c), bezierToPoints(A, w, y, P, _, m, o, r, h, l, c + 2 + (l.length - d))),
            l
        );
    }
    function pointsToSegment(t, e, n) {
        var i,
            ...
            x = P - b,
            S = A - y,
            C = Math.abs(t[v] - b) < 0.001 && Math.abs(t[v + 1] - y) < 0.001;
        for (isNaN(n) && (n = Math.PI / 10), C && (t.push(P, A), (P = b), (A = y), (b = t[v - 2]), (y = t[v - 1]), t.unshift(b, y), (v += 4)), e = e || 0 === e ? +e : 1, h = 2; h < v; h += 2)
            (i = b),
                (s = y),
                (b = P),
                (y = A),
                (f = (l = x) * l + (d = S) * d),
                (_ = (x = (P = +t[h + 2]) - b) * x + (S = (A = +t[h + 3]) - y) * S),
                (m = (c = P - i) * c + (u = A - s) * u),
                (g = ((a = Math.acos((f + _ - m) / K(4 * f * _))) / Math.PI) * e),
                (p = K(f) * g),
                (g *= K(_)),
                (b === i && y === s) ||
                    (n < a
                        ? ((r = E(u, c)), w.push(o(b - F(r) * p), o(y - W(r) * p), o(b), o(y), o(b + F(r) * g), o(y + W(r) * g)))
                        : ((r = E(d, l)), w.push(o(b - F(r) * p), o(y - W(r) * p)), (r = E(S, x)), w.push(o(b), o(y), o(b + F(r) * g), o(y + W(r) * g))));
        return w.push(o(P), o(A), o(P), o(A)), C && (w.splice(0, 6), (w.length = w.length - 6)), w;
    }
            ...
            (function simplifyStep(t, e, n, i, s) {
                ...
                for (o = e + 2; o < n; o += 2)
                    (h = t[o]),
                        ...
                        (g = void 0),
                        (_ = (p = P) - (d = b)),
                        ((f = (u = y) - (c = v)) || _) && (1 < (g = ((h - c) * f + (l - d) * _) / (f * f + _ * _)) ? ((c = u), (d = p)) : 0 < g && ((c += f * g), (d += _ * g))),
    ...
    function getClosestProgressOnBezier(t, e, n, i, s, a, o, r, h, l, c, d, u, p) {
        var g,
            ...
            y = i;
        for (P = A; y <= s; )
            (g = (f = (m = 1 - y) * m * m * o + 3 * m * m * y * h + 3 * m * y * y * c + y * y * y * u - e) * f + (_ = m * m * m * r + 3 * m * m * y * l + 3 * m * y * y * d + y * y * y * p - n) * _) < P && ((P = g), (b = y)), (y += v);
        return 1 < t ? getClosestProgressOnBezier(t - 1, e, n, Math.max(b - v, 0), Math.min(b + v, 1), a, o, r, h, l, c, d, u, p) : b;
    }
    function B(t) {
        var e = t.ownerDocument || t;
        !(b in t.style) && "msTransform" in t.style && (y = (b = "msTransform") + "Origin");
        for (; e.parentNode && (e = e.parentNode); );
        if (((g = window), (m = new k()), e)) {
            (f = (u = e).documentElement), (_ = e.body);
            var n = e.createElement("div"),
                i = e.createElement("div");
            _.appendChild(n), n.appendChild(i), (n.style.position = "static"), (n.style[b] = "translate3d(0,0,1px)"), (v = i.offsetParent !== n), _.removeChild(n);
        }
        return e;
    }
    function H(t) {
    ...
    function J(t, e) {
        if (t.parentNode && (u || B(t))) {
            var n = H(t),
                i = n ? n.getAttribute("xmlns") || "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml",
                s = n ? (e ? "rect" : "g") : "div",
                a = 2 !== e ? 0 : 100,
                o = 3 === e ? 100 : 0,
                r = "position:absolute;display:block;pointer-events:none;",
                h = u.createElementNS ? u.createElementNS(i.replace(/^https/, "http"), s) : u.createElement(s);
            return (
                e &&
                    (n
                        ? ((d = d || J(t)), h.setAttribute("width", 0.01), h.setAttribute("height", 0.01), h.setAttribute("transform", "translate(" + a + "," + o + ")"), d.appendChild(h))
                        : (c || ((c = J(t)).style.cssText = r), (h.style.cssText = r + "width:0.1px;height:0.1px;top:" + o + "px;left:" + a + "px"), c.appendChild(h))),
                h
            );
        }
    ...
    function L(t, e) {
        var n,
            ...
            l = r ? S : C;
        if (t === g) return t;
        if ((l.length || l.push(J(t, 1), J(t, 2), J(t, 3)), (n = r ? d : c), r))
            (s = h ? { x: 0, y: 0 } : t.getBBox()),
                (o = (i = t.transform ? t.transform.baseVal : {}).numberOfItems
                    ? ((a =
                          (i =
                              1 < i.numberOfItems
                ...
                (h ? r : t.parentNode).appendChild(n);
        else {
            if (((a = o = 0), v)) for (i = t.offsetParent, s = t; (s = s && s.parentNode) && s !== i && s.parentNode; ) 4 < (g.getComputedStyle(s)[b] + "").length && ((a = s.offsetLeft), (o = s.offsetTop), (s = 0));
            ((s = n.style).top = t.offsetTop - o + "px"),
                ...
                (s[y] = i[y]),
                (s.border = i.border),
                (s.borderLeftStyle = i.borderLeftStyle),
                (s.borderTopStyle = i.borderTopStyle),
                (s.borderLeftWidth = i.borderLeftWidth),
                (s.borderTopWidth = i.borderTopWidth),
                (s.position = "fixed" === i.position ? "fixed" : "absolute"),
        ...
        k =
            (((e = Matrix2D.prototype).inverse = function inverse() {
                var t = this.a,
                    ...
                    a = this.f,
                    o = t * i - e * n || 1e-10;
                return M(this, i / o, -e / o, -n / o, t / o, (n * a - i * s) / o, -(t * a - e * s) / o);
            }),
            (e.multiply = function multiply(t) {
                var e = this.a,
                    ...
                    d = t.e,
                    u = t.f;
                return M(this, r * e + l * i, r * n + l * s, h * e + c * i, h * n + c * s, a + d * e + u * i, o + d * n + u * s);
            }),
    ...
    function Matrix2D(t, e, n, i, s, a) {
        void 0 === t && (t = 1), void 0 === e && (e = 0), void 0 === n && (n = 0), void 0 === i && (i = 1), void 0 === s && (s = 0), void 0 === a && (a = 0), M(this, t, e, n, i, s, a);
    }
    function getGlobalMatrix(t, e, n) {
        if (!t || !t.parentNode || (u || B(t)).documentElement === t) return new k();
        var i = (function _forceNonZeroScale(t) {
                for (var e, n; t && t !== _; ) (n = t._gsap) && !n.scaleX && !n.scaleY && n.renderTransform && ((n.scaleX = n.scaleY = 1e-4), n.renderTransform(1, n), e ? e.push(n) : (e = [n])), (t = t.parentNode);
                return e;
            })(t.parentNode),
            s = H(t) ? S : C,
            a = L(t, n),
            o = s[0].getBoundingClientRect(),
            r = s[1].getBoundingClientRect(),
            h = s[2].getBoundingClientRect(),
            l = a.parentNode,
            c = (function _isFixed(t) {
                ...
                o.left +
                    (c
                        ...
                        : (function _getDocScrollLeft() {
                              return g.pageXOffset || u.scrollLeft || f.scrollLeft || _.scrollLeft || 0;
                          })()),
                o.top +
                    (c
                        ? 0
                        : (function _getDocScrollTop() {
                              return g.pageYOffset || u.scrollTop || f.scrollTop || _.scrollTop || 0;
                          })())
            );
        if ((l.removeChild(a), i)) for (o = i.length; o--; ) ((r = i[o]).scaleX = r.scaleY = 0), r.renderTransform(1, r);
    ...
    function ma(t, e, n) {
        var i,
            s = D.createElementNS("http://www.w3.org/2000/svg", t),
            a = /([a-z])([A-Z])/g;
    ...
    function ua(t) {
        if (!t.target._gsSelection && !et && 100 < Q() - tt) {
            for (var e = ot.length; -1 < --e; ) ot[e].deselect();
            ot.length = 0;
        }
    }
    function ya(t, e, n, i) {
    ...
    function Ba(t) {
        (a = t.touches && _dragCount < t.touches.length), za(t.target, "touchend", Ba);
    }
    function Ca(t) {
        (a = t.touches && _dragCount < t.touches.length), ya(t.target, "touchend", Ba);
    }
    function Da(e, n) {
        return function (t) {
            return e.call(n, t);
    ...
    function Ga() {
        (G.style.display = "block"), G.select(), (G.style.display = "none");
    }
    function Ja(t) {
        var e,
            n,
        ...
        (this._matrix = this.target.transform.baseVal.getItem(0).matrix),
            (this._ctm = s),
            I[t.type]
                ? ((e = -1 !== t.type.indexOf("touch") ? t.currentTarget || t.target : D),
                  ya(e, "touchend", i._onRelease),
                  ya(e, "touchmove", i._onMove),
                  ya(e, "touchcancel", i._onRelease),
                  ya(D, "touchstart", Ca),
                  ya(T, "touchforcechange", ka))
                : ((e = null), ya(D, "mousemove", i._onMove)),
            h || ya(D, "mouseup", i._onRelease),
            ka(t),
            Ga(),
    ...
    function Ka(t) {
        ...
        if (i._enabled && !a && i.isPressed && t) {
            ...
            ka(s), i.setPointerPosition(t.pageX, t.pageY), i.vars.onDrag && i.vars.onDrag.call(i.vars.callbackScope || i, i.pointerEvent);
        }
    }
    function La(t, e) {
        var n = this;
        if (
            ...
            if (
                (r ? (za(r, "touchend", n._onRelease), za(r, "touchmove", n._onMove), za(r, "touchcancel", n._onRelease), za(D, "touchstart", Ca)) : za(D, "mousemove", n._onMove),
                h || (za(D, "mouseup", n._onRelease), t && t.target && za(t.target, "mouseup", n._onRelease)),
            ...
            return (
                a && !o && n.vars.onDragRelease ? n.vars.onDragRelease.call(n, n.pointerEvent) : (a && ka(a), n.vars.onRelease && n.vars.onRelease.call(n.vars.callbackScope || n, n.pointerEvent)),
    ...
    function Ma(t, e, n, i) {
        var s,
            a = t[e].length,
            o = [];
        for (s = 0; s < a; s += 6) o.push(new lt(n, t, e, s, i));
        return o;
    }
    function Na(t, e, n) {
        var i = t[n] - t[e],
        ...
        rt =
            (((n = DraggableSVG.prototype).setPointerPosition = function setPointerPosition(t, e) {
                ...
                (this.pointerX = t),
                    ...
                    this.snap && !N && ((it.x = s), (it.y = a), this.snap.call(this, it), (s = it.x), (a = it.y)),
                    (this.x === s && this.y === a) || ((this._matrix.f = this.y = a), (this._matrix.e = this.x = s), !this.isDragging && this.isPressed && ((this.isDragging = !0), Ea("onDragStart", this, this.pointerEvent)));
            }),
            (n.enabled = function enabled(t) {
                return arguments.length
                    ? ((this._enabled = t)
                          ? (h || ya(this.target, "mousedown", this._onPress), ya(this.target, "touchstart", this._onPress), ya(this.target, "click", this._onClick, !0))
                          : ((e = this.isDragging),
                            za(this.target, "mousedown", this._onPress),
                            za(this.target, "touchstart", this._onPress),
                            za(T, "touchforcechange", ka),
                            za(this.target, "click", this._onClick),
                            this.touchEventTarget && (za(this.touchEventTarget, "touchcancel", this._onRelease), za(this.touchEventTarget, "touchend", this._onRelease), za(this.touchEventTarget, "touchmove", this._onMove)),
                            za(D, "mouseup", this._onRelease),
                            za(D, "mousemove", this._onMove),
                            (this.isDragging = this.isPressed = !1),
                            e && Ea("onDragEnd", this, this.pointerEvent)),
                      this)
                    : this._enabled;
                var e;
            }),
    ...
    function DraggableSVG(t, e) {
        (this.target = "string" == typeof t ? D.querySelectorAll(t)[0] : t),
            (this.vars = e || {}),
            (this._onPress = Da(Ja, this)),
            (this._onMove = Da(Ka, this)),
            (this._onRelease = Da(La, this)),
            this.target.setAttribute("transform", (this.target.getAttribute("transform") || "") + " translate(0,0)"),
            (this._matrix = oa(this.target)),
        ...
        lt =
            ...
            (ht.update = function update(t, e, n) {
                ...
                var i = this.smooth,
                    s = this.rawPath[e];
                (this.segment = s),
                    (this.smooth = n && n < s.length - 2 && Math.abs(Math.atan2(s[n + 1] - s[n - 1], s[n] - s[n - 2]) - Math.atan2(s[n + 3] - s[n + 1], s[n + 2] - s[n])) < 0.09 ? 2 : 0),
    ...
    function Anchor(t, e, n, i, s) {
        (this.editor = t),
            (this.element = ma("path", t._selection, { fill: Y, stroke: Y, strokeWidth: 2, vectorEffect: "non-scaling-stroke" })),
            this.update(e, n, i),
    ...
    var ct,
        dt =
            (((ct = PathEditor.prototype)._onRelease = function _onRelease(t) {
                ...
                e && ((i.x = e.segment[e.i]), (i.y = e.segment[e.i + 1])), za(T, "touchforcechange", ka), Ea("onRelease", this, t);
            }),
            (ct.init = function init() {
                ...
                if (((this._rawPath = i), a)) {
                    if (((this._anchors = Ma(i, 0, this, o)), 1 < (t = i.length))) for (e = 1; e < t; e++) this._anchors = this._anchors.concat(Ma(i, e, this, o));
                ...
                return (
                    ...
                    this._g.setAttribute(
                        ...
                        (function _getConcatenatedTransforms(t) {
                            for (var e = oa(t), n = t.ownerSVGElement; (t = t.parentNode) && t.ownerSVGElement === n; ) e.multiply(oa(t));
            ...
            (ct._saveState = function _saveState() {
                !(function _addHistory(t) {
                    ...
                    nt.unshift({ path: t, d: t.path.getAttribute("d"), transform: t.path.getAttribute("transform") || "", selectedIndexes: n }), 30 < nt.length && (nt.length = 30);
                })(this);
            }),
            (ct._onClickSelectionPath = function _onClickSelectionPath(t) {
                if ("hidden" === this._selection.style.visibility) this.select();
                    ...
                    for (
                        this._draggable && this._draggable._onRelease(t),
                            l && ((s = t.clientX * l.a + t.clientY * l.c + l.e), (a = t.clientX * l.b + t.clientY * l.d + l.f)),
                            ...
                            (function subdivideSegment(t, e, n) {
                                ...
                                return (
                                    (d += (_ - d) * n),
                                    (p += (m - p) * n),
                                    t.splice(e + 2, 4, o(c), o(u), o(g), o(f), o(g + (d - g) * n), o(f + (p - f) * n), o(d), o(p), o(_), o(m)),
                    ...
                    (i = new lt(this, this._rawPath, r.j, e, h)),
                        this._selection.appendChild(this._handle1),
                        this._selection.appendChild(this._handle2),
                ...
                Ga(), ya(T, "touchforcechange", ka), Ea("onPress", this);
            }),
            (ct._onClickHandle1 = function _onClickHandle1() {
                var t = this._editingAnchor,
                    e = t.i,
                    n = t.segment;
                R && Math.abs(n[e] - n[e - 2]) < 5 && Math.abs(n[e + 1] - n[e - 1]) < 5 && this._onClickAnchor(t);
            }),
            ...
            (ct.select = function select(t) {
                ...
                return -1 === ot.indexOf(this) && ot.push(this), this._updateAnchors(), this;
            }),
            (ct.deselect = function deselect() {
                return (this._selection.style.visibility = "hidden"), (this._selectedAnchors.length = 0), (this._editingAnchor = null), (this.path._gsSelection = !1), ot.splice(ot.indexOf(this), 1), this._updateAnchors(), this;
            }),
            ...
            (ct._onPressAnchor = function _onPressAnchor(t) {
                -1 === this._selectedAnchors.indexOf(t) ? (N || (this._selectedAnchors.length = 0), this._selectedAnchors.push(t)) : N && (this._selectedAnchors.splice(this._selectedAnchors.indexOf(t), 1), t._draggable.endDrag()),
                    (i.x = t.segment[t.i]),
                    (i.y = t.segment[t.i + 1]),
                    this._updateAnchors(),
                    Ea("onPress", this);
            ...
            (ct._onClickAnchor = function _onClickAnchor(t) {
                var e,
                    ...
                    l = 1e3,
                    c = !r || r >= h.length - 2;
                R && X !== t && this._editingAnchor
                    ? ((t.smooth = !t.smooth),
                      c && (t.smooth = !1),
                      t.element.setAttribute("d", t.smooth ? this._circleHandle : this._squareHandle),
                      t.smooth && !c
                          ? ((e = ((e = Math.atan2(h[r + 1] - h[r - 1], h[r] - h[r - 2])) + (n = Math.atan2(h[r + 3] - h[r + 1], h[r + 2] - h[r]))) / 2),
                            (i = Na(h, r - 2, r)),
                            (s = Na(h, r, r + 2)),
                            i < 0.2 && ((i = Na(h, r, r - 6) / 4), (e = n || Math.atan2(h[r + 7] - h[r - 5], h[r + 6] - h[r - 6]))),
                            s < 0.2 && ((s = Na(h, r, r + 6) / 4), (n = e || Math.atan2(h[r + 7] - h[r - 5], h[r + 6] - h[r - 6]))),
                            (a = Math.sin(e)),
                            (o = Math.cos(e)),
                            Math.abs(n - e) < Math.PI / 2 && ((a = -a), (o = -o)),
                            (h[r - 2] = (((h[r] + o * i) * l) | 0) / l),
                            (h[r - 1] = (((h[r + 1] + a * i) * l) | 0) / l),
                            (h[r + 2] = (((h[r] - o * s) * l) | 0) / l),
                            (h[r + 3] = (((h[r + 1] - a * s) * l) | 0) / l),
                            this._updateAnchors(),
                            this.update(),
                            this._saveState())
                          : t.smooth || c || (r && ((h[r - 2] = h[r]), (h[r - 1] = h[r + 1])), r < h.length - 2 && ((h[r + 2] = h[r]), (h[r + 3] = h[r + 1])), this._updateAnchors(), this.update(), this._saveState()))
                    : N || ((this._selectedAnchors.length = 0), this._selectedAnchors.push(t)),
                    (X = null),
                    this._updateAnchors();
            }),
            (ct._updateAnchors = function _updateAnchors() {
                var t,
                    ...
                    s = i ? i.segment : null;
                for (this._editingAnchor = i, t = 0; t < this._anchors.length; t++) this._anchors[t].element.style.fill = -1 !== this._selectedAnchors.indexOf(this._anchors[t]) ? Y : "white";
                i && (this._handle1.setAttribute("d", i.smooth ? this._circleHandle : this._squareHandle), this._handle2.setAttribute("d", i.smooth ? this._circleHandle : this._squareHandle)),
                    ...
                    i && t
                        ? ((e = s[t - 2]),
                          ...
                          this._handle1.setAttribute("transform", "translate(" + e + at + n + ")"),
                          this._line1.setAttribute("points", e + at + n + at + s[t] + at + s[t + 1]))
                    ...
                    i && t < s.length - 2
                        ? ((e = s[t + 2]),
                          ...
                          this._handle2.setAttribute("transform", "translate(" + e + at + n + ")"),
                          this._line2.setAttribute("points", s[t] + at + s[t + 1] + at + e + at + n))
            ...
            (ct._onReleaseAlt = function _onReleaseAlt() {
                ...
                n &&
                    ((t = n.segment)[(e = n.i)] === t[e - 2] && t[e + 1] === t[e - 1] && (this._handle1.style.visibility = this._line1.style.visibility = "hidden"),
            ...
            (ct._onPressHandle1 = function _onPressHandle1() {
                this._editingAnchor.smooth && (this._oppositeHandleLength = Na(this._editingAnchor.segment, this._editingAnchor.i, this._editingAnchor.i + 2)), Ea("onPress", this);
            }),
            (ct._onPressHandle2 = function _onPressHandle2() {
                this._editingAnchor.smooth && (this._oppositeHandleLength = Na(this._editingAnchor.segment, this._editingAnchor.i - 2, this._editingAnchor.i)), Ea("onPress", this);
            }),
                ...
                (n[i - 2] = a = ((a * s) | 0) / s),
                    ...
                    e.smooth &&
                        (R
                            ...
                            : ((t = Math.atan2(n[i + 1] - o, n[i] - a)),
                              (a = this._oppositeHandleLength * Math.cos(t)),
            ...
            (ct._onDragAnchor = function _onDragAnchor(t, e, n) {
                var i,
                    ...
                    a,
                    o,
                    r = this._selectedAnchors,
                    h = r.length,
                    l = 1e3;
                for (s = 0; s < h; s++)
                    (i = (o = r[s]).i),
                        (a = o.segment),
                        i && ((a[i - 2] = (((a[i - 2] + e) * l) | 0) / l), (a[i - 1] = (((a[i - 1] + n) * l) | 0) / l)),
                        (a[i] = (((a[i] + e) * l) | 0) / l),
                        (a[i + 1] = (((a[i + 1] + n) * l) | 0) / l),
                        i < a.length - 2 && ((a[i + 2] = (((a[i + 2] + e) * l) | 0) / l), (a[i + 3] = (((a[i + 3] + n) * l) | 0) / l)),
                        o !== t && o.element.setAttribute("transform", "translate(" + a[i] + at + a[i + 1] + ")");
                this.update();
            }),
            ...
            (ct.update = function update(t) {
                var e,
                    ...
                    s,
                    a = "",
                    o = this._editingAnchor;
                if (
                    (t && this.init(),
                    o &&
                        ((e = o.i),
                        (n = o.segment),
                        e && ((i = n[e - 2]), (s = n[e - 1]), this._handle1.setAttribute("transform", "translate(" + i + at + s + ")"), this._line1.setAttribute("points", i + at + s + at + n[e] + at + n[e + 1])),
                        e < n.length - 2 && ((i = n[e + 2]), (s = n[e + 3]), this._handle2.setAttribute("transform", "translate(" + i + at + s + ")"), this._line2.setAttribute("points", n[e] + at + n[e + 1] + at + i + at + s))),
                    t)
                )
                    a = this.path.getAttribute("d");
                else {
                    for (e = 0; e < this._rawPath.length; e++) 7 < (n = this._rawPath[e]).length && (a += "M" + n[0] + at + n[1] + "C" + n.slice(2).join(at));
                    this.path.setAttribute("d", a), this._selectionPath.setAttribute("d", a), this._selectionHittest.setAttribute("d", a);
                }
                return this.vars.onUpdate && this._enabled && Ea("onUpdate", this, a), this;
            }),
            ...
            (ct.getString = function getString(t, e, n) {
                if (t) {
                    var i = oa(this.path);
            ...
            (ct.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
                var s,
                    ...
                    g = 1 / (c[p - 2] + d),
                    f = -t || c[p - 1] + u;
                for (f = f ? 1 / f : -g, g *= 1e3, f *= 1e3, a = st.length = 0; a < p; a += 2) (st[a] = (((c[a] + d) * g) | 0) / 1e3), (st[a + 1] = (((c[a + 1] + u) * f) | 0) / 1e3);
                if (i) {
                    for (s = [], p = st.length, a = 2; a < p; a += 6)
                        (o = st[a - 2]), (r = st[a - 1]), (h = st[a + 4]), (l = st[a + 5]), s.push(o, r, h, l), bezierToPoints(o, r, st[a], st[a + 1], st[a + 2], st[a + 3], h, l, 0.001, s, s.length - 2);
                ...
                return n && 8 === p && 0 === st[0] && 0 === st[1] && 1 === st[p - 2] && 1 === st[p - 1] ? st.slice(2, 6).join(",") : ((st[2] = "C" + st[2]), "M" + st.join(","));
            }),
            PathEditor);
    function PathEditor(t, e) {
            ...
            V ||
                (function _initCore() {
                    (D = document),
                        ...
                        (r = D.body),
                        (O = la("div")),
                        ((G = la("textarea")).style.display = "none"),
                        r && r.appendChild(G),
                        (I = (function (t) {
                            for (
                                var e = t.split(","),
                        ...
                        D.addEventListener(
                            ...
                            function (t) {
                                ...
                                else if ("Meta" === o || 91 === a) z = !0;
                                else if ("Alt" === o || 18 === a) for (R = !0, e = ot.length; -1 < --e; ) ot[e]._onPressAlt();
                                else if (("z" === o || 90 === a) && (l || z) && 1 < nt.length) {
                                    if ((nt.shift(), (n = nt[0]))) {
                                ...
                                } else if ("Delete" === o || "Backspace" === o || 8 === a || 46 === a || 63272 === a || ("d" === a && (l || z))) for (e = ot.length; -1 < --e; ) ot[e]._deleteSelectedAnchors();
                                else if (("a" === o || 65 === a) && (z || l)) for (e = ot.length; -1 < --e; ) ot[e].select(!0);
                            },
                            !0
                        ),
                        D.addEventListener(
                            ...
                            function (t) {
                                ...
                                if ("Shift" === e || 16 === e) N = !1;
                                    ...
                                    R = !1;
                                    for (var n = ot.length; -1 < --n; ) ot[n]._onReleaseAlt();
                                }
                            },
                            !0
                        ),
                        ...
                        ya(D, "touchcancel", Z),
                        ya(T, "touchmove", Z),
                        r && r.addEventListener("touchstart", Z),
                        (V = 1);
                })(),
            (this.vars = e),
            (this.path = "string" == typeof t ? D.querySelectorAll(t)[0] : t),
            (this._g = ma("g", this.path.ownerSVGElement, { class: "path-editor-g path-editor" })),
            (this._selectionHittest = ma("path", this._g, { stroke: "transparent", strokeWidth: 16, fill: "none", vectorEffect: "non-scaling-stroke" })),
            (this._selection = e._selection || ma("g", this._g, { class: "path-editor-selection path-editor" })),
            (this._selectionPath = ma("path", this._selection, { stroke: Y, strokeWidth: 2, fill: "none", vectorEffect: "non-scaling-stroke" })),
            (this._selectedAnchors = []),
            (this._line1 = ma("polyline", this._selection, { stroke: Y, strokeWidth: 2, vectorEffect: "non-scaling-stroke" })),
            (this._line2 = ma("polyline", this._selection, { stroke: Y, strokeWidth: 2, vectorEffect: "non-scaling-stroke" })),
        ...
        (this._squareHandle = (function _getSquarePathData(t) {
            return ["M-" + (t = ra(t)), -t, t, -t, t, t, -t, t + "z"].join(at);
        })(i)),
            (this._circleHandle = (function _getCirclePathData(t) {
                var e = ra(0.552284749831 * t);
                return "M" + (t = ra(t)) + ",0C" + [t, e, e, t, 0, t, -e, t, -t, e, -t, 0, -t, -e, -e, -t, 0, -t, e, -t, t, -e, t, 0].join(at) + "z";
            })(1.15 * i)),
            (this._handle1 = ma("path", this._selection, { d: this._squareHandle, fill: Y, stroke: "transparent", strokeWidth: 6 })),
            (this._handle2 = ma("path", this._selection, { d: this._squareHandle, fill: Y, stroke: "transparent", strokeWidth: 6 })),
        ...
        !1 !== e.draggable &&
            ...
            !1 !== e.selected && ((this.path._gsSelection = !0), ot.push(this)),
            this._saveState(),
            h || (ya(this._selectionHittest, "mousedown", Da(this._onClickSelectionPath, this)), ya(this._selectionHittest, "mouseup", Da(this._onRelease, this))),
            ya(this._selectionHittest, "touchstart", Da(this._onClickSelectionPath, this)),
            ya(this._selectionHittest, "touchend", Da(this._onRelease, this));
    }
    (dt.simplifyPoints = simplifyPoints),
        (dt.pointsToSegment = pointsToSegment),
        (dt.simplifySVG = function (t, e) {
            var n, i, s, a, o, r, h, l, c, d, u, p;
            if (
                ((d = (e = e || {}).tolerance || 1),
                (c = e.precision || 1 / d),
                (p = (void 0 === e.cornerThreshold ? 18 : +e.cornerThreshold) * $),
                "string" != typeof t && (t = (n = t).getAttribute("d")),
                ("#" !== t.charAt(0) && "." !== t.charAt(0)) || ((n = D.querySelector(t)) && (t = n.getAttribute("d"))),
                (i = !1 !== e.curved || /[achqstvz]/gi.test(t) ? stringToRawPath(t)[0] : t.match(q)),
                !1 !== e.curved)
            ) {
                for (l = i, i = [], u = l.length, s = 2; s < u; s += 6)
                    (a = +l[s - 2]), (r = +l[s - 1]), (o = +l[s + 4]), (h = +l[s + 5]), i.push(ra(a), ra(r), ra(o), ra(h)), bezierToPoints(a, r, +l[s], +l[s + 1], +l[s + 2], +l[s + 3], o, h, 1 / (2e5 * c), i, i.length - 2);
                (i = pointsToSegment(simplifyPoints(i, d), e.curviness, p))[2] = "C" + i[2];
            ...
            return (
                ...
                function (t) {
                    ...
                    (u && a < h) || (i = a - h) * i < r ? (a = h) : ((u && c < a) || (i = c - a) * i < r) && (a = c),
                        (p && o < l) || (s = o - l) * s < r ? (o = l) : ((p && d < o) || (s = d - o) * s < r) && (o = d),
                        g && ((i = a - g.x), (s = o - g.y), i * i < r && (a = g.x), s * s < r && (o = g.y)),
    ...
    function kb(t, e, n) {
        return db(t) && wt.test(t) ? gt.querySelector(t) : Array.isArray(t) ? bt(vt([{ x: ut.getProperty(e, "x"), y: ut.getProperty(e, "y") }].concat(t), n)) : db(t) || (t && "path" === (t.tagName + "").toLowerCase()) ? t : 0;
    }
    function pb(t, e) {
        var n = "Please gsap.registerPlugin(MotionPathPlugin)";
        (pt = window),
            (ut = ut || t || pt.gsap || console.warn(n)),
            (gt = document),
            (_t = gt.body),
            (ft = gt.documentElement),
            (mt = ut && ut.plugins.motionPath)
                ? ((function _initCopyToClipboard() {
                      ((yt = eb("textarea")).style.display = "none"), _t.appendChild(yt);
                  })(),
    ...
    var ut,
        ...
        yt,
        Pt = "MotionPathHelper",
        At = _a(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
        wt =
            ((function (t) {return true})(window ? window.location.host : ""),
            /(^[#\.][a-z]|[a-y][a-z])/i),
        ...
        t instanceof ut.core.Tween
            ...
            (r = (function _getPositionOnPage(t) {
                var e = t.getBoundingClientRect(),
                    n = ft.clientTop - (pt.pageYOffset || ft.scrollTop || _t.scrollTop || 0),
            ...
            (a = parseFloat(ut.getProperty(n, "x", "px"))),
            (o = parseFloat(ut.getProperty(n, "y", "px"))),
            (s = n.getCTM && "svg" !== n.tagName.toLowerCase()),
            l && !i && (i = kb(l.vars.motionPath.path || l.vars.motionPath, n, l.vars.motionPath)),
            ...
            (f._gsHelper = _),
            (ut.utils.toArray(e.container)[0] || _t).appendChild(f),
            (function _addCopyToClipboard(n, i, s) {
                n.addEventListener("click", function (t) {
                    if (t.target._gsHelper) {
                        var e = i(t.target);
                        if ((yt.value = e) && yt.select) {
                            console.log(e), (yt.style.display = "block"), yt.select();
                            try {
                                gt.execCommand("copy"), yt.blur(), s && s(n);
                            } catch (t) {
                ...
                function () {
                    return ut.fromTo(f, { backgroundColor: "white" }, { duration: 0.5, backgroundColor: "rgba(85, 85, 85, 0.6)" });
                }
            ),
            (h = i && i.ownerSVGElement) ||
                ...
                s
                    ...
                    : ((h = eb("svg", c)),
                      ...
                      (h.style.cssText = "overflow:visible; background-color: transparent; position:absolute; width:100px; height:100px; top:" + r.top + "px; left:" + r.left + "px;")),
                (d =
                    db(i) && !wt.test(i)
                        ? i
                ...
                h.appendChild(i),
                (m.x || m.y) && ut.set(i, { x: m.x, y: m.y })),
            "selected" in e || (e.selected = !0),
            "anchorSnap" in e ||
                (e.anchorSnap = function (t) {
                    t.x * t.x + t.y * t.y < 16 && (t.x = t.y = 0);
                }),
            (g = l && "nested" === l.parent.data ? l.parent.parent : l),
            (e.onPress = function () {
                g.pause(0);
            }),
            (p = function refreshPath() {
                l.invalidate(), g.restart();
            }),
            (e.onRelease = e.onDeleteAnchor = p),
            (this.editor = dt.create(i, e)),
            e.center && ut.set(n, { transformOrigin: "50% 50%", xPercent: -50, yPercent: -50 }),
            l
                ? (l.vars.motionPath.path ? (l.vars.motionPath.path = i) : (l.vars.motionPath = { path: i }),
                  g.parent !== ut.globalTimeline &&
